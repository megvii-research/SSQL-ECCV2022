...
__all__ = ["cifar_resnet18",  "cifar_resnet34", "cifar_resnet50", "cifar_resnet101", "cifar_resnet152"]
...
def cifar_resnet34(num_classes=128, **kwargs):
    return ResNet(CIFAR_BasicBlock, [3,4,6,3], num_classes)

def cifar_resnet50(num_classes=128, **kwargs):
    return ResNet(CIFAR_Bottleneck, [3,4,6,3], num_classes)

def cifar_resnet101(num_classes=128, **kwargs):
    return ResNet(CIFAR_Bottleneck, [3,4,23,3], num_classes)

def cifar_resnet152(num_classes=128, **kwargs):
